...
namespace scrawble
{
    class Algorithm
    {
       public:
         ...
         */
        virtual std::list<Move> randomPlacement(const Board &board, const Rack &rack) = 0;
         ...
         */
        virtual std::list<Move> longestPlacement(const Board &board, const Rack &rack) = 0;
         ...
         *              configuration.
         */
        virtual std::list<Move> calculateHighestScorePlacement(const Board &board, const Rack &rack) = 0;
    };
}
#endif
